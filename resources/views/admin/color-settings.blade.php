        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="mb-6">
                        <h3 class="text-lg font-semibold text-gray-800 mb-2">Pengaturan Warna Global</h3>
                        <p class="text-sm text-gray-600">Atur warna background dan font untuk tampilan pesan</p>
                    </div>
